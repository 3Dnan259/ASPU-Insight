...
// ✏️ تعديل: القسم اليميني فقط (QR + المفتاح اليدوي + زر المتابعة)
//    عمود التعليمات مخفي بالكامل حسب الطلب — راجع setup-2fa-split.css
          ...
          <div className="form-panel split-layout">
            ...
            <div className="panel split-panel">
              ...
              <div className="fh split-header">
                ...
                <p className="fsub ar">افتح تطبيق Google Authenticator وامسح الرمز أدناه لربط حسابك.</p>
              ...
              {/* القسم اليميني (الوحيد الظاهر): QR + المفتاح اليدوي + زر المتابعة */}
              <div className="split-col-qr">
                ...
                {/* زر المتابعة — نقلناه ليظهر تحت QR بنفس اللوحة */}
                <button
                  className="btn"
